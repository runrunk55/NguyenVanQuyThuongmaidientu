...
namespace NguyenVanQuyThuongmaidientu.Server.Migrations
{
    ...
    [Migration("20240706125027_AddPaymentTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NguyenVanQuyThuongmaidientu.Server.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("NguyenVanQuyThuongmaidientu.Shared.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("NguyenVanQuyThuongmaidientu.Shared.Product", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("NguyenVanQuyThuongmaidientu.Server.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("NguyenVanQuyThuongmaidientu.Shared.Product", b =>
                {
                    b.HasOne("NguyenVanQuyThuongmaidientu.Shared.Category", "Category")
                        .WithMany()
